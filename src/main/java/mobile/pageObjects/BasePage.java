...
public class BasePage {
    ...
    protected boolean textToBe(By by, String  text){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        return wait.until(ExpectedConditions.textToBe(by, text));
    }

    protected boolean textContains(WebElement webElement, String  text){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        return wait.until(ExpectedConditions.visibilityOf(webElement)).getText().contains(text);
    }
    ...
    protected WebElement scrollDownUntilElementFound(WebDriver driver, WebElement element, int maxSwipes) {
        ...
        while (swipes < maxSwipes) {
            try {
                WebElement webElement = visibilityOf(element);
                //System.out.printf("***********" + webElement.getText());
                return webElement;
            } catch (TimeoutException e) {
                //System.out.printf("scrolllingggggg................ ");
